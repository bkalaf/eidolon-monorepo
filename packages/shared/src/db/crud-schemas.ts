...
const densityValues = [Density.Compact, Density.Spacious, Density.Comfy] as const;
...
const themePreferenceValues = [ThemePreference.Light, ThemePreference.Dark, ThemePreference.System] as const;
...
const invitationStatusValues = [InvitationStatus.Pending, InvitationStatus.Redeemed, InvitationStatus.Revoked] as const;
...
export const createCrudSchemas = <Entity extends object, Insert extends object>(
    zEntity: z.ZodObject<z.ZodRawShape, 'strip', Entity>,
    zInsert: z.ZodObject<z.ZodRawShape, 'strip', Insert>
